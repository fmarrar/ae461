...
MAKECMD         = "C:/MATLAB~3/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := ae461starter
MODULES              := ae461starter_data.c ae461starter_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := ae461starter.mk
MATLAB_ROOT          := C:/MATLAB~3
MATLAB_BIN           := C:/MATLAB~3/bin
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
SLDRTDIR             := C:/MATLAB~3/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ae461starter_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/AE461/ABG;C:/AE461/ABG/ae461starter_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src;$(MATLAB_ROOT)/rtw/c/coecsl/devices
